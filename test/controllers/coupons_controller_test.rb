...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { concept: @coupon.concept, course: @coupon.course, price: @coupon.price, restaurant_id: @coupon.restaurant_id }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { concept: @coupon.concept, course: @coupon.course, price: @coupon.price, restaurant_id: @coupon.restaurant_id }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
