...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { finish_time: @banner.finish_time, image: @banner.image, link: @banner.link, start_time: @banner.start_time }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { finish_time: @banner.finish_time, image: @banner.image, link: @banner.link, start_time: @banner.start_time }
    assert_redirected_to banner_path(assigns(:banner))
  end
