class BannersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @banner.save
        format.html { redirect_to :action => "index", notice: 'Banner was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @banner.update(banner_params)
        format.html { redirect_to :action => "index", notice: 'Banner was successfully updated.' }
  ...
  private
    ...
    def banner_params
      params.require(:banner).permit(:link, :start_time, :finish_time,
        photo_attributes: [:banner_id, :images, :images_cache])
    end
